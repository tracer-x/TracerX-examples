...
To run the examples, first edit `Makefile.settings` to set the right values for your environment. Then To run the the example(s) in a particular directory, say `basic`, change your current directory to the `basic` directory.
