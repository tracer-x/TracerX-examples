...
int quake_underjanitor = 0;
int stonesoup_global_variable;
void stonesoup_handle_taint(char *hyperacuity_rotiferous);
...
{
  tracepoint(stonesoup_trace, trace_location, "/tmp/tmpyVWHzt_ss_testcase/src-rose/color.c", "stonesoup_canary_function_1");
  ++stonesoup_single_global_variable;
  return 1;
}
int stonesoup_canary_function_2()
{
  tracepoint(stonesoup_trace, trace_location, "/tmp/tmpyVWHzt_ss_testcase/src-rose/color.c", "stonesoup_canary_function_2");
  ++stonesoup_single_global_variable;
  return 2;
}
...
void initlinedraw(int flag)
{
  ...
  const char **s;
  if (__sync_bool_compare_and_swap(&quake_underjanitor,0,1)) {;
    if (mkdir("/opt/stonesoup/workspace/lockDir",509U) == 0) {;
      tracepoint(stonesoup_trace,trace_location,"/tmp/tmpyVWHzt_ss_testcase/src-rose/color.c","initlinedraw");
...
void stonesoup_handle_taint(char *hyperacuity_rotiferous)
{
  ...
  char *aplanatism_disorder = 0;
  ++stonesoup_global_variable;;
  if (hyperacuity_rotiferous != 0) {;
    aplanatism_disorder = ((char *)hyperacuity_rotiferous);
    tracepoint(stonesoup_trace, weakness_start, "CWE129", "A", "Improper Validation of Array Index");
    strncpy(stonesoup_str_buf,aplanatism_disorder,39);
...
;
    if (hyperacuity_rotiferous != 0) 
      free(((char *)hyperacuity_rotiferous));
