...
cd
cd nus/kleetest
llvm-gcc --emit-llvm -c -g addition_depend.c
llvm-gcc -S --emit-llvm addition_depend.c
opt -analyze -dot-cfg addition_depend.o
klee -write-pcs -use-query-log=all:pc,all:smt2 -search=dfs addition_depend.o
