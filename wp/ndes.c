...
static char ipc1[57] = { 0,  57, 49, 41, 33, 25, 17, 9,  1,  58, 50, 42,
                         34, 26, 18, 10, 2,  59, 51, 43, 35, 27, 19, 11,
                         3,  60, 52, 44, 36, 63, 55, 47, 39, 31, 23, 15,
...
void des(immense inp, immense key, int *newkey, int isw, immense *out) {
  ...
  wcet += 2;
  static great kns[17];
  klee_make_symbolic(&kns, 17 * sizeof(great), "kns");
  ...
  klee_make_symbolic(&ic, sizeof(unsigned long), "ic");
  klee_make_symbolic(&shifter, sizeof(unsigned long), "shifter");
  klee_make_symbolic(&itmp, sizeof(immense), "itmp");
  klee_make_symbolic(&pg, sizeof(great), "pg");
...
void cyfun(unsigned long ir, great k, unsigned long *iout) {
  ...
  static char is[16][4][9] = { { { 0, 14, 15, 10, 7, 2, 12, 4, 13 },
  ...
  unsigned long *p;
  klee_make_symbolic(&itmp, sizeof(unsigned long), "itmp");
  klee_make_symbolic(&ietmp1, sizeof(unsigned long), "ietmp1");
  klee_make_symbolic(&ietmp2, sizeof(unsigned long), "ietmp2");
  klee_make_symbolic(&iec, 9 * sizeof(char), "iec");
  klee_make_symbolic(&jj, sizeof(int), "jj");
  klee_make_symbolic(&irow, sizeof(int), "irow");
  klee_make_symbolic(&icol, sizeof(int), "icol");
  klee_make_symbolic(&iss, sizeof(int), "iss");
  klee_make_symbolic(&j, sizeof(int), "j");
  klee_make_symbolic(&l, sizeof(int), "l");
...
int main(void) {
  ...
  immense inp, key, out;
  int newkey, isw;
  klee_make_symbolic(&inp, sizeof(immense), "inp");
  klee_make_symbolic(&key, sizeof(immense), "key");
  klee_make_symbolic(&out, sizeof(immense), "out");
  klee_make_symbolic(&newkey, sizeof(int), "newkey");
  klee_make_symbolic(&isw, sizeof(int), "isw");
