...
#else
  klee_make_symbolic(P1_marking_member_0, 3 * sizeof(long),
                     "P1_marking_member_0");
  klee_make_symbolic(P2_marking_member_0, 5 * sizeof(long),
                     "P2_marking_member_0");
  klee_make_symbolic(P3_marking_member_0, 6 * sizeof(long),
                     "P3_marking_member_0");
#endif
