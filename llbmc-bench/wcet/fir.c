/* MDH WCET BENCHMARK SUITE. File version $Id: fir.c,v 1.5 2005/11/11 10:30:29 ael01 Exp $ */
/*
clang -g -emit-llvm -c fir.c -o fir.o
~/git/original/klee/Release+Asserts/bin/klee fir.o 
*/
