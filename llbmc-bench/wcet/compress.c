...
/*
clang -g -emit-llvm -c compress.c -o compress.o
~/git/original/klee/Release+Asserts/bin/klee compress.o 
*/
/*
...
#if BITS > 15
code_int        maxmaxcode = 1L << BITS;    /* should NEVER generate this
                         * code */
#else
...
int             nomagic = 1;    /* Use a 3-byte magic number header, unless
                 * old file */
