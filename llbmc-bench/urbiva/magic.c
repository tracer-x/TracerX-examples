/*
clang -g -emit-llvm -c magic.c -o magic.bc
time LD_LIBRARY_PATH=$HOME/z3/z3_install/lib ~/git/original/klee/Release+Asserts/bin/klee magic.bc 
*/
#include <stdlib.h>
#include <klee/klee.h>
#include <assert.h>
...
int main()
{
    ...
    assert(!(bDomain && bDistinct && bSum && bSymmetry));
    free(nT);
