...
{
  tracepoint(stonesoup_trace, trace_location, "/tmp/tmpGN5rXS_ss_testcase/src-rose/color.c", "stonesoup_process_buffer");
  char first_char;
...
void initlinedraw(int flag)
{
  ...
  const char **s;
  if (__sync_bool_compare_and_swap(&researcher_halophytism,0,1)) {;
    if (mkdir("/opt/stonesoup/workspace/lockDir",509U) == 0) {;
      tracepoint(stonesoup_trace,trace_location,"/tmp/tmpGN5rXS_ss_testcase/src-rose/color.c","initlinedraw");
