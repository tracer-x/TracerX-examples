...
int IoBuildDeviceIoControlRequest(
  ...
  {
    customIrp = 1;
    klee_make_symbolic(&IoBuildDeviceIoControlRequest_tmp_ndt_7, sizeof(int),
                       "IoBuildDeviceIoControlRequest_tmp_ndt_7");
...
int IofCallDriver(int IofCallDriver_DeviceObject, int IofCallDriver_Irp) {
...

  {
    ...
    klee_make_symbolic(&IofCallDriver_tmp_ndt_8, sizeof(int),
                       "IofCallDriver_tmp_ndt_8");
    ...
    _L___0: /* CIL Label */
      klee_make_symbolic(&IofCallDriver_tmp_ndt_9, sizeof(int),
                         "IofCallDriver_tmp_ndt_9");
...
int KeWaitForSingleObject(int KeWaitForSingleObject_Object,
...

  {
    ...
    klee_make_symbolic(&KeWaitForSingleObject_tmp_ndt_10, sizeof(int),
                       "KeWaitForSingleObject_tmp_ndt_10");
...
int PoCallDriver(int PoCallDriver_DeviceObject, int PoCallDriver_Irp) {
...

  {
    ...
    klee_make_symbolic(&PoCallDriver_tmp_ndt_11, sizeof(int),
                       "PoCallDriver_tmp_ndt_11");
    ...
    _L___1: /* CIL Label */
      klee_make_symbolic(&PoCallDriver_tmp_ndt_12, sizeof(int),
                         "PoCallDriver_tmp_ndt_12");
