...
unsigned Climb_Inhibit;
  ...
  klee_make_symbolic(&Two_of_Three_Reports_Valid, sizeof(unsigned), "Two_of_Three_Reports_Valid");
  klee_make_symbolic(&Own_Tracked_Alt, sizeof(unsigned), "Own_Tracked_Alt");
  klee_make_symbolic(&Own_Tracked_Alt_Rate, sizeof(unsigned), "Own_Tracked_Alt_Rate");
  ...
  klee_make_symbolic(&Positive_RA_Alt_Thresh__0, sizeof(unsigned), "Positive_RA_Alt_Thresh__0");
  klee_make_symbolic(&Positive_RA_Alt_Thresh__1, sizeof(unsigned), "Positive_RA_Alt_Thresh__1");
  klee_make_symbolic(&Positive_RA_Alt_Thresh__2, sizeof(unsigned), "Positive_RA_Alt_Thresh__2");
  klee_make_symbolic(&Positive_RA_Alt_Thresh__3, sizeof(unsigned), "Positive_RA_Alt_Thresh__3");
  ...
  klee_make_symbolic(&result_Non_Crossing_Biased_Climb, sizeof(unsigned), "result_Non_Crossing_Biased_Climb");
  klee_make_symbolic(&result_Non_Crossing_Biased_Descend, sizeof(unsigned), "result_Non_Crossing_Biased_Descend");
  ...
  if ((enabled !=0)&& (((tcas_equipped !=0)&& (intent_not_known !=0)) 
	...
	klee_make_symbolic(&upward_preferred_1, sizeof(unsigned), "upward_preferred_1");
	klee_make_symbolic(&alim_Non_Crossing_Biased_Climb, sizeof(unsigned), "alim_Non_Crossing_Biased_Climb");
	...
	if (Climb_Inhibit==1) {temp11= Up_Separation + 100; wcet += 1;}
	else {temp11 = Up_Separation; wcet += 1;}
	...
	klee_make_symbolic(&upward_preferred_2, sizeof(unsigned), "upward_preferred_2");
	klee_make_symbolic(&alim_Non_Crossing_Biased_Descend, sizeof(unsigned), "alim_Non_Crossing_Biased_Descend");
