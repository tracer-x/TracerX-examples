...
int main()
{
  ...
  if(b1>0) a[0] = v1; else a[0] = v2;
  if(b2>0) a[1] = v1; else a[1] = v2;
  if(b3>0) a[2] = v1; else a[2] = v2;    
  if(b4>0) a[3] = v1; else a[3] = v2;
  if(b5>0) a[4] = v1; else a[4] = v2;
  if(b6>0) a[5] = v1; else a[5] = v2;      
  if(b7>0) a[6] = v1; else a[6] = v2;  
  if(b1>0) a[7] = v1; else a[7] = v2;
