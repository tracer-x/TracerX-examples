...
{ msg_t m1 ;
  ...
  m1 = nomsg;
  if (mode1) {
    r1 = (char )((unsigned char )((int )r1 + 1));
    m1 = p8_old;
    p8_old = nomsg;
    if ((int )m1 != (int )nomsg) {
      if ((int )m1 > (int )id1) {
...
{ msg_t m7 ;
  ...
  if (mode7) {
    ...
    if ((int )send7 != (int )nomsg) {
      if ((int )p7_new == (int )nomsg) {
        p7_new = send7;
      } else {
        p7_new = p7_new;
      }
...
{ msg_t m8 ;
  ...
  if (mode8) {
    ...
    if ((int )send8 != (int )nomsg) {
      if ((int )p8_new == (int )nomsg) {
        p8_new = send8;
      } else {
        p8_new = p8_new;
      }
...
{ 
  ...
  id7 = __llbmc_nondef_char();
  st7 = __llbmc_nondef_char();
  send7 = __llbmc_nondef_char();
  mode7 = __llbmc_nondef_int();
  
  id8 = __llbmc_nondef_char();
  st8 = __llbmc_nondef_char();
  send8 = __llbmc_nondef_char();
