...
void DiskPerfSyncFilterWithTarget(
    int DiskPerfSyncFilterWithTarget_FilterDevice,
    int DiskPerfSyncFilterWithTarget_TargetDevice) {

  { return; }
}
int DiskPerfStartDevice(int DiskPerfStartDevice_DeviceObject,
                        int DiskPerfStartDevice_Irp);
int DiskPerfRemoveDevice(int DiskPerfRemoveDevice_DeviceObject,
                         int DiskPerfRemoveDevice_Irp);
int DiskPerfSendToNextDriver(int DiskPerfSendToNextDriver_DeviceObject,
                             int DiskPerfSendToNextDriver_Irp);
int DiskPerfDispatchPnp(int DiskPerfDispatchPnp_DeviceObject,
                        int DiskPerfDispatchPnp_Irp) {
  ...
  {
    TRACER_returning = 0;
    DiskPerfDispatchPnp_irpSp =
        DiskPerfDispatchPnp_Irp__Tail__Overlay__CurrentStackLocation;
    if (DiskPerfDispatchPnp_irpSp__MinorFunction >= 0) {
      if (DiskPerfDispatchPnp_irpSp__MinorFunction <= 0) {
        DiskPerfDispatchPnp_status = DiskPerfStartDevice(
            DiskPerfDispatchPnp_DeviceObject, DiskPerfDispatchPnp_Irp);
      } else {
        goto _L;
      }
    } else {
    _L: /* CIL Label */
      if (DiskPerfDispatchPnp_irpSp__MinorFunction >= 2) {
        if (DiskPerfDispatchPnp_irpSp__MinorFunction <= 2) {
          DiskPerfDispatchPnp_status = DiskPerfRemoveDevice(
              DiskPerfDispatchPnp_DeviceObject, DiskPerfDispatchPnp_Irp);
        } else {
          DiskPerfDispatchPnp_tmp = DiskPerfSendToNextDriver(
              DiskPerfDispatchPnp_DeviceObject, DiskPerfDispatchPnp_Irp);
...
int KeSetEvent(int KeSetEvent_Event, int KeSetEvent_Increment,
               int KeSetEvent_Wait);
int DiskPerfIrpCompletion(int DiskPerfIrpCompletion_DeviceObject,
                          int DiskPerfIrpCompletion_Irp,
                          int DiskPerfIrpCompletion_Context) {
...
int DiskPerfForwardIrpSynchronous(
    int DiskPerfForwardIrpSynchronous_DeviceObject,
    int DiskPerfForwardIrpSynchronous_Irp);
...
int DiskPerfStartDevice(int DiskPerfStartDevice_DeviceObject,
  ...
  {
    DiskPerfStartDevice_deviceExtension =
        DiskPerfStartDevice_DeviceObject__DeviceExtension;
    DiskPerfStartDevice_status = DiskPerfForwardIrpSynchronous(
        DiskPerfStartDevice_DeviceObject, DiskPerfStartDevice_Irp);
    DiskPerfSyncFilterWithTarget(
        DiskPerfStartDevice_DeviceObject,
        DiskPerfStartDevice_deviceExtension__TargetDeviceObject);
...
int DiskPerfRemoveDevice(int DiskPerfRemoveDevice_DeviceObject,
  ...
  {
    DiskPerfRemoveDevice_deviceExtension =
        DiskPerfRemoveDevice_DeviceObject__DeviceExtension;
    DiskPerfRemoveDevice_wmilibContext =
        DiskPerfRemoveDevice_deviceExtension__WmilibContext;
    DiskPerfRemoveDevice_status = DiskPerfForwardIrpSynchronous(
        DiskPerfRemoveDevice_DeviceObject, DiskPerfRemoveDevice_Irp);
...
int DiskPerfSendToNextDriver(int DiskPerfSendToNextDriver_DeviceObject,
...

  {
    safety = safety + (s - NP);
    s = SKIP1;
    DiskPerfSendToNextDriver_Irp__CurrentLocation =
        DiskPerfSendToNextDriver_Irp__CurrentLocation + 1;
    DiskPerfSendToNextDriver_Irp__Tail__Overlay__CurrentStackLocation =
        DiskPerfSendToNextDriver_Irp__Tail__Overlay__CurrentStackLocation + 1;
    DiskPerfSendToNextDriver_deviceExtension =
        DiskPerfSendToNextDriver_DeviceObject__DeviceExtension;
    DiskPerfSendToNextDriver_tmp = IofCallDriver(
        DiskPerfSendToNextDriver_deviceExtension__TargetDeviceObject,
        DiskPerfSendToNextDriver_Irp);
    return (DiskPerfSendToNextDriver_tmp);
  }
}
int PoCallDriver(int PoCallDriver_DeviceObject, int PoCallDriver_Irp);
int DiskPerfDispatchPower(int DiskPerfDispatchPower_DeviceObject,
                          int DiskPerfDispatchPower_Irp) {
...

  {
    safety = safety + (s - NP);
    s = SKIP1;
    DiskPerfDispatchPower_Irp__CurrentLocation =
        DiskPerfDispatchPower_Irp__CurrentLocation + 1;
    DiskPerfDispatchPower_Irp__Tail__Overlay__CurrentStackLocation =
        DiskPerfDispatchPower_Irp__Tail__Overlay__CurrentStackLocation + 1;
    DiskPerfDispatchPower_deviceExtension =
        DiskPerfDispatchPower_DeviceObject__DeviceExtension;
    DiskPerfDispatchPower_tmp =
        PoCallDriver(DiskPerfDispatchPower_deviceExtension__TargetDeviceObject,
                     DiskPerfDispatchPower_Irp);
...
int DiskPerfForwardIrpSynchronous(
  ...
  {
    DiskPerfForwardIrpSynchronous_deviceExtension =
        DiskPerfForwardIrpSynchronous_DeviceObject__DeviceExtension;
    DiskPerfForwardIrpSynchronous_irpSp =
        DiskPerfForwardIrpSynchronous_Irp__Tail__Overlay__CurrentStackLocation;
    DiskPerfForwardIrpSynchronous_nextIrpSp =
        DiskPerfForwardIrpSynchronous_Irp__Tail__Overlay__CurrentStackLocation -
        1;
    ...
    compRegistered = 1;
    routine = 0;
    DiskPerfForwardIrpSynchronous_irpSp___0 =
        DiskPerfForwardIrpSynchronous_Irp__Tail__Overlay__CurrentStackLocation -
        1;
    DiskPerfForwardIrpSynchronous_irpSp__Context =
        DiskPerfForwardIrpSynchronous_event;
    DiskPerfForwardIrpSynchronous_irpSp__Control = 224;
    DiskPerfForwardIrpSynchronous_status = IofCallDriver(
        DiskPerfForwardIrpSynchronous_deviceExtension__TargetDeviceObject,
        DiskPerfForwardIrpSynchronous_Irp);
    DiskPerfForwardIrpSynchronous_CIL___Tmp15 =
        DiskPerfForwardIrpSynchronous_status;
    if (DiskPerfForwardIrpSynchronous_CIL___Tmp15 >= 259) {
      if (DiskPerfForwardIrpSynchronous_CIL___Tmp15 <= 259) {
        KeWaitForSingleObject(DiskPerfForwardIrpSynchronous_event, Executive,
                              KernelMode, 0, 0);
...
int DiskPerfDeviceControl(int DiskPerfDeviceControl_DeviceObject,
                          int DiskPerfDeviceControl_Irp) {
  ...
  {
    TRACER_returning = 0;
    DiskPerfDeviceControl_deviceExtension =
        DiskPerfDeviceControl_DeviceObject__DeviceExtension;
    DiskPerfDeviceControl_currentIrpStack =
        DiskPerfDeviceControl_Irp__Tail__Overlay__CurrentStackLocation;
    DiskPerfDeviceControl_CIL___Tmp24 = 32;
    DiskPerfDeviceControl_CIL___Tmp25 = 458752;
    DiskPerfDeviceControl_CIL___Tmp26 = 458784;
    if (DiskPerfDeviceControl_currentIrpStack__Parameters__DeviceIoControl__IoControlCode >=
        DiskPerfDeviceControl_CIL___Tmp26) {
      if (DiskPerfDeviceControl_currentIrpStack__Parameters__DeviceIoControl__IoControlCode <=
          DiskPerfDeviceControl_CIL___Tmp26) {
        if (DiskPerfDeviceControl_currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength <
            DiskPerfDeviceControl_sizeof__DISK_PERFORMANCE) {
          DiskPerfDeviceControl_status = -1073741789;
          DiskPerfDeviceControl_Irp__IoStatus__Information = 0;
        } else {
          DiskPerfDeviceControl_diskCounters =
              DiskPerfDeviceControl_deviceExtension__DiskCounters;
          if (DiskPerfDeviceControl_diskCounters >= 0) {
            if (DiskPerfDeviceControl_diskCounters <= 0) {
              ...
              DiskPerfDeviceControl_totalCounters =
                  DiskPerfDeviceControl_Irp__AssociatedIrp__SystemBuffer;
              DiskPerfDeviceControl_i = 0;
              DiskPerfDeviceControl_totalCounters__QueueDepth =
                  DiskPerfDeviceControl_deviceExtension__QueueDepth;
              DiskPerfDeviceControl_status = 0;
              DiskPerfDeviceControl_Irp__IoStatus__Information =
                  DiskPerfDeviceControl_sizeof__DISK_PERFORMANCE;
            }
          } else {
            DiskPerfDeviceControl_totalCounters =
        ...
        if (TRACER_returning <= 0) {
          DiskPerfDeviceControl_Irp__IoStatus__Status =
              DiskPerfDeviceControl_status;
          myStatus = DiskPerfDeviceControl_status;
          IofCompleteRequest(DiskPerfDeviceControl_Irp, 0);
          retres27 = DiskPerfDeviceControl_status;
        }
      } else {
        DiskPerfDeviceControl_Irp__CurrentLocation =
            DiskPerfDeviceControl_Irp__CurrentLocation + 1;
        DiskPerfDeviceControl_Irp__Tail__Overlay__CurrentStackLocation =
            DiskPerfDeviceControl_Irp__Tail__Overlay__CurrentStackLocation + 1;
        DiskPerfDeviceControl_tmp = IofCallDriver(
            DiskPerfDeviceControl_deviceExtension__TargetDeviceObject,
            DiskPerfDeviceControl_Irp);
...
int DiskPerfShutdownFlush(int DiskPerfShutdownFlush_DeviceObject,
                          int DiskPerfShutdownFlush_Irp) {
  ...
  {
    DiskPerfShutdownFlush_deviceExtension =
        DiskPerfShutdownFlush_DeviceObject__DeviceExtension;
    DiskPerfShutdownFlush_Irp__CurrentLocation =
        DiskPerfShutdownFlush_Irp__CurrentLocation + 1;
    DiskPerfShutdownFlush_Irp__Tail__Overlay__CurrentStackLocation =
        DiskPerfShutdownFlush_Irp__Tail__Overlay__CurrentStackLocation + 1;
    DiskPerfShutdownFlush_tmp =
        IofCallDriver(DiskPerfShutdownFlush_deviceExtension__TargetDeviceObject,
                      DiskPerfShutdownFlush_Irp);
...
int DiskPerfRegisterDevice(int DiskPerfRegisterDevice_DeviceObject) {
...

  {
    ...
    DiskPerfRegisterDevice_deviceExtension =
        DiskPerfRegisterDevice_DeviceObject__DeviceExtension;
    ...
    DiskPerfRegisterDevice_irp = IoBuildDeviceIoControlRequest(
        DiskPerfRegisterDevice_CIL___Tmp22,
        DiskPerfRegisterDevice_deviceExtension__TargetDeviceObject, 0, 0,
        DiskPerfRegisterDevice_number, DiskPerfRegisterDevice_sizeof__number, 0,
        DiskPerfRegisterDevice_event, DiskPerfRegisterDevice_ioStatus);
    ...
    _L___4: /* CIL Label */
      DiskPerfRegisterDevice_status = IofCallDriver(
          DiskPerfRegisterDevice_deviceExtension__TargetDeviceObject,
          DiskPerfRegisterDevice_irp);
      DiskPerfRegisterDevice_CIL___Tmp23 = DiskPerfRegisterDevice_status;
      if (DiskPerfRegisterDevice_CIL___Tmp23 >= 259) {
        if (DiskPerfRegisterDevice_CIL___Tmp23 <= 259) {
          KeWaitForSingleObject(DiskPerfRegisterDevice_event, Executive,
                                KernelMode, 0, 0);
          DiskPerfRegisterDevice_status =
              DiskPerfRegisterDevice_ioStatus__Status;
        }
      }
      if (DiskPerfRegisterDevice_status < 0) {
        DiskPerfRegisterDevice_outputSize =
            DiskPerfRegisterDevice_sizeof__MOUNTDEV_NAME;
        ...
        _L___3: /* CIL Label */
          ...
          DiskPerfRegisterDevice_irp = IoBuildDeviceIoControlRequest(
              DiskPerfRegisterDevice_CIL___Tmp26,
              DiskPerfRegisterDevice_deviceExtension__TargetDeviceObject, 0, 0,
              DiskPerfRegisterDevice_output, DiskPerfRegisterDevice_outputSize,
              0, DiskPerfRegisterDevice_event, DiskPerfRegisterDevice_ioStatus);
          if (DiskPerfRegisterDevice_irp >= 0) {
            if (DiskPerfRegisterDevice_irp <= 0) {
              retres37 = -1073741670;
              TRACER_returning = 1;
          ...
          _L___2: /* CIL Label */
            ...
            if (DiskPerfRegisterDevice_CIL___Tmp28 >= -2147483643) {
              if (DiskPerfRegisterDevice_CIL___Tmp28 <= -2147483643) {
                DiskPerfRegisterDevice_outputSize =
                    DiskPerfRegisterDevice_sizeof__MOUNTDEV_NAME +
                    DiskPerfRegisterDevice_output__NameLength;
                if (DiskPerfRegisterDevice_output >= 0) {
                  if (DiskPerfRegisterDevice_output <= 0) {
                    retres37 = -1073741670;
                    TRACER_returning = 1;
                ...
                _L___0: /* CIL Label */
                  ...
                  DiskPerfRegisterDevice_irp = IoBuildDeviceIoControlRequest(
                      DiskPerfRegisterDevice_CIL___Tmp31,
                      DiskPerfRegisterDevice_deviceExtension__TargetDeviceObject,
                      0, 0, DiskPerfRegisterDevice_output,
                      DiskPerfRegisterDevice_outputSize, 0,
                      DiskPerfRegisterDevice_event,
                      DiskPerfRegisterDevice_ioStatus);
                  if (DiskPerfRegisterDevice_irp >= 0) {
                    if (DiskPerfRegisterDevice_irp <= 0) {
                      retres37 = -1073741670;
                      TRACER_returning = 1;
                  ...
                  _L: /* CIL Label */
                    DiskPerfRegisterDevice_status = IofCallDriver(
                        DiskPerfRegisterDevice_deviceExtension__TargetDeviceObject,
                        DiskPerfRegisterDevice_irp);
                    DiskPerfRegisterDevice_CIL___Tmp32 =
                        DiskPerfRegisterDevice_status;
                    if (DiskPerfRegisterDevice_CIL___Tmp32 >= 259) {
                      if (DiskPerfRegisterDevice_CIL___Tmp32 <= 259) {
                        KeWaitForSingleObject(DiskPerfRegisterDevice_event,
            ...
            if (TRACER_returning <= 0) {
              if (DiskPerfRegisterDevice_status < 0) {
                ...
                DiskPerfRegisterDevice_irp = IoBuildDeviceIoControlRequest(
                    DiskPerfRegisterDevice_CIL___Tmp36,
                    DiskPerfRegisterDevice_deviceExtension__TargetDeviceObject,
                    0, 0, DiskPerfRegisterDevice_volumeNumber,
                    DiskPerfRegisterDevice_sizeof__VOLUME_NUMBER, 0,
                    DiskPerfRegisterDevice_event,
                    DiskPerfRegisterDevice_ioStatus);
                if (DiskPerfRegisterDevice_irp >= 0) {
                  if (DiskPerfRegisterDevice_irp <= 0) {
                ...
                _L___1: /* CIL Label */
                  DiskPerfRegisterDevice_status = IofCallDriver(
                      DiskPerfRegisterDevice_deviceExtension__TargetDeviceObject,
                      DiskPerfRegisterDevice_irp);
                  DiskPerfRegisterDevice_CIL___Tmp37 =
                      DiskPerfRegisterDevice_status;
...
int IoBuildDeviceIoControlRequest(
...

  {
    customIrp = 1;
#ifdef LLBMC
  IoBuildDeviceIoControlRequest_tmp_ndt_7 = __llbmc_nondef_int();
#else
...

  {
    if (compRegistered > 0) {
      ...
      _L: /* CIL Label */
        if (routine >= 0) {
          if (routine <= 0) {
            IofCallDriver_compRetStatus = DiskPerfIrpCompletion(
                IofCallDriver_DeviceObject, IofCallDriver_Irp,
                IofCallDriver_lcontext);
          } else {
            IofCallDriver_compRetStatus =
                DiskPerfIoCompletion(IofCallDriver_DeviceObject,
                                     IofCallDriver_Irp, IofCallDriver_lcontext);
          }
        } else {
          IofCallDriver_compRetStatus =
              DiskPerfIoCompletion(IofCallDriver_DeviceObject,
...
#ifdef LLBMC
  IofCallDriver_tmp_ndt_8 = __llbmc_nondef_int();
#else
  klee_make_symbolic(&IofCallDriver_tmp_ndt_8, sizeof(int), "IofCallDriver_tmp_ndt_8");
    ...
    _L___0: /* CIL Label */
#ifdef LLBMC
  IofCallDriver_tmp_ndt_9 = __llbmc_nondef_int();
#else
...
#ifdef LLBMC
  KeWaitForSingleObject_tmp_ndt_10 = __llbmc_nondef_int();
#else
      ...
      _L___0: /* CIL Label */
        if (routine >= 0) {
          if (routine <= 0) {
            PoCallDriver_compRetStatus =
                DiskPerfIrpCompletion(PoCallDriver_DeviceObject,
                                      PoCallDriver_Irp, PoCallDriver_lcontext);
          } else {
            goto _L;
          }
        } else {
        _L: /* CIL Label */
          if (routine >= 1) {
            if (routine <= 1) {
              PoCallDriver_compRetStatus =
                  DiskPerfIoCompletion(PoCallDriver_DeviceObject,
                                       PoCallDriver_Irp, PoCallDriver_lcontext);
            }
          }
        }
...
#ifdef LLBMC
  PoCallDriver_tmp_ndt_11 = __llbmc_nondef_int();
#else
  klee_make_symbolic(&PoCallDriver_tmp_ndt_11, sizeof(int), "PoCallDriver_tmp_ndt_11");
    ...
    _L___1: /* CIL Label */
#ifdef LLBMC
  PoCallDriver_tmp_ndt_12 = __llbmc_nondef_int();
#else
...
  main_tmp_ndt_4 = __llbmc_nondef_int();
  ...
  klee_make_symbolic(&main_tmp_ndt_4, sizeof(int), "main_tmp_ndt_4");
            ...
            _L: /* CIL Label */
#ifdef LLBMC
  main_tmp_ndt_5 = __llbmc_nondef_int();
#else
