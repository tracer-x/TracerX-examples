...
#else
    klee_make_symbolic(&IofCallDriver_tmp_ndt_6, sizeof(int), "IofCallDriver_tmp_ndt_6");
#endif                         
...
#else
    klee_make_symbolic(&IofCallDriver_tmp_ndt_7, sizeof(int), "IofCallDriver_tmp_ndt_7");
#endif    
...
#ifdef LLBMC
    KeWaitForSingleObject_tmp_ndt_8 = __llbmc_nondef_int();
#else
    klee_make_symbolic(&KeWaitForSingleObject_tmp_ndt_8, sizeof(int), "KeWaitForSingleObject_tmp_ndt_8");
#endif    
...
int PoCallDriver(int PoCallDriver_DeviceObject, int PoCallDriver_Irp) {
  ...
    PoCallDriver_tmp_ndt_9 = __llbmc_nondef_int();
#else
    klee_make_symbolic(&PoCallDriver_tmp_ndt_9, sizeof(int), "PoCallDriver_tmp_ndt_9");
#endif    
    ...
    _L___0: /* CIL Label */
#ifdef LLBMC
    PoCallDriver_tmp_ndt_10 = __llbmc_nondef_int();
#else
    klee_make_symbolic(&PoCallDriver_tmp_ndt_10, sizeof(int), "PoCallDriver_tmp_ndt_10");
#endif    
