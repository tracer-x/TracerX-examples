        ...
        _L___0: /* CIL Label */
          if (FloppyStartDevice_fdcInfo__AcpiFdiSupported > 0) {
            ...
            _L: /* CIL Label */
              ...
              if (FloppyStartDevice_disketteExtension__DriveType >= 4) {
                if (FloppyStartDevice_disketteExtension__DriveType <= 4) {
...
int IoBuildDeviceIoControlRequest(
...

  {
    customIrp = 1;
#ifdef LLBMC
  IoBuildDeviceIoControlRequest_tmp_ndt_2 = __llbmc_nondef_int();
#else
    klee_make_symbolic(&IoBuildDeviceIoControlRequest_tmp_ndt_2, sizeof(int),
                       "IoBuildDeviceIoControlRequest_tmp_ndt_2");
#endif    
...
int IoDeleteSymbolicLink(int IoDeleteSymbolicLink_SymbolicLinkName) {
  ...
  {
#ifdef LLBMC
  IoDeleteSymbolicLink_tmp_ndt_3 = __llbmc_nondef_int();
#else
    klee_make_symbolic(&IoDeleteSymbolicLink_tmp_ndt_3, sizeof(int),
                       "IoDeleteSymbolicLink_tmp_ndt_3");
#endif      

    if (IoDeleteSymbolicLink_tmp_ndt_3 >= 0) {
      if (IoDeleteSymbolicLink_tmp_ndt_3 <= 0) {
        retres3 = 0;
      } else {
        retres3 = -1073741823;
...
int IoRegisterDeviceInterface(
  ...
  {
#ifdef LLBMC
  IoRegisterDeviceInterface_tmp_ndt_5 = __llbmc_nondef_int();
#else
    klee_make_symbolic(&IoRegisterDeviceInterface_tmp_ndt_5, sizeof(int),
                       "IoRegisterDeviceInterface_tmp_ndt_5");
#endif        
...
int IoSetDeviceInterfaceState(int IoSetDeviceInterfaceState_SymbolicLinkName,
  ...
  {
#ifdef LLBMC
  IoSetDeviceInterfaceState_tmp_ndt_6 = __llbmc_nondef_int();
#else
    klee_make_symbolic(&IoSetDeviceInterfaceState_tmp_ndt_6, sizeof(int),
                       "IoSetDeviceInterfaceState_tmp_ndt_6");
#endif    

    if (IoSetDeviceInterfaceState_tmp_ndt_6 >= 0) {
      if (IoSetDeviceInterfaceState_tmp_ndt_6 <= 0) {
        retres4 = 0;
      } else {
        retres4 = -1073741823;
...
#ifdef LLBMC
  IofCallDriver_tmp_ndt_7 = __llbmc_nondef_int();
#else
...
#ifdef LLBMC
  KeWaitForSingleObject_tmp_ndt_9 = __llbmc_nondef_int();
#else
    klee_make_symbolic(&KeWaitForSingleObject_tmp_ndt_9, sizeof(int),
                       "KeWaitForSingleObject_tmp_ndt_9");
#endif        
        
    if (KeWaitForSingleObject_tmp_ndt_9 >= 0) {
      if (KeWaitForSingleObject_tmp_ndt_9 <= 0) {
        retres7 = 0;
      } else {
        retres7 = -1073741823;
...
int ObReferenceObjectByHandle(int ObReferenceObjectByHandle_Handle,
  ...
  {
#ifdef LLBMC
  ObReferenceObjectByHandle_tmp_ndt_10 = __llbmc_nondef_int();
#else
    klee_make_symbolic(&ObReferenceObjectByHandle_tmp_ndt_10, sizeof(int),
                       "ObReferenceObjectByHandle_tmp_ndt_10");
#endif        
...
int PsCreateSystemThread(int PsCreateSystemThread_ThreadHandle,
  ...
  {
#ifdef LLBMC
  PsCreateSystemThread_tmp_ndt_11 = __llbmc_nondef_int();
#else
    klee_make_symbolic(&PsCreateSystemThread_tmp_ndt_11, sizeof(int),
                       "PsCreateSystemThread_tmp_ndt_11");
#endif        
...
int ZwClose(int ZwClose_Handle) {
  ...
  {
#ifdef LLBMC
  ZwClose_tmp_ndt_12 = __llbmc_nondef_int();
#else
    klee_make_symbolic(&ZwClose_tmp_ndt_12, sizeof(int),
                       "ZwClose_tmp_ndt_12");
#endif        
  
    if (ZwClose_tmp_ndt_12 >= 0) {
      if (ZwClose_tmp_ndt_12 <= 0) {
        retres3 = 0;
      } else {
        retres3 = -1073741823;
