...
int c1 ;
  ...
  send1 = __llbmc_nondef_char();
  mode1 = __llbmc_nondef_int();
  alive1 = __llbmc_nondef_int();
  
  id2 = __llbmc_nondef_char();
  st2 = __llbmc_nondef_char();
  send2 = __llbmc_nondef_char();
  mode2 = __llbmc_nondef_int();
  alive2 = __llbmc_nondef_int();
  
  id3 = __llbmc_nondef_char();
  st3 = __llbmc_nondef_char();
  send3 = __llbmc_nondef_char();
  mode3 = __llbmc_nondef_int();
  alive3 = __llbmc_nondef_int();
  
  id4 = __llbmc_nondef_char();
  st4 = __llbmc_nondef_char();
  send4 = __llbmc_nondef_char();
  mode4 = __llbmc_nondef_int();
  alive4 = __llbmc_nondef_int();
  
  id5 = __llbmc_nondef_char();
  st5 = __llbmc_nondef_char();
  send5 = __llbmc_nondef_char();
  mode5 = __llbmc_nondef_int();
  alive5 = __llbmc_nondef_int();
  
  id6 = __llbmc_nondef_char();
  st6 = __llbmc_nondef_char();
  send6 = __llbmc_nondef_char();
  mode6 = __llbmc_nondef_int();
  alive6 = __llbmc_nondef_int();
  #else
